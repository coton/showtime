...
/*================================= 建立表空间及对应dba*/
 -- create user
 GRANT USAGE ON *.* TO 'showtime'@'localhost' IDENTIFIED BY 'showtime' WITH GRANT OPTION;
 -- create database
 CREATE DATABASE showtime CHARACTER SET  utf8  COLLATE utf8_general_ci;
 ...
 GRANT SELECT,INSERT,UPDATE,DELETE,CREATE,DROP,LOCK TABLES ON showtime.*  TO 'showtime'@'localhost' IDENTIFIED BY 'showtime';
